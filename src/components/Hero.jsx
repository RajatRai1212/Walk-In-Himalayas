  ...
  return (
    <div className='w-full h-[100vh]'>
      ...
      <div className='max-w-[1140px] m-auto'>
        <div className='absolute top-[25%] w-full sm:top-[40%] md:-[50%] max-w-[600px] h-full flex flex-col text-white p-4'>
          <h1 className='font-bold text-4xl'>Find Your Special Trip With</h1>
          <h2 className='text-4xl py-4 italic text-gray-400'>
            Walk In <span className='text-black'>Himalayas</span>
          </h2>
          <p >
